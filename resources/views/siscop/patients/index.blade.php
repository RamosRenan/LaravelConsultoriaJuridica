...
@section('content_header')
    <h1><i class="fa fa-ambulance"></i> @lang('global.dentist.patients.title') <small>@lang('global.app_list')</small></h1>
@stop
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-8">
                    <p>
                        <a href="{{ route('dentist.patients.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                    </p>
                </div>
                <div class="col-md-4">
                    {!! Form::open(['style' => 'display: inline-block;', 'method' => 'GET', 'route' => ['dentist.patients.index']]) !!}
            ...
            <table class="table table-bordered table-striped dt-select">
                <thead>
                    <tr>
                        ...
                        <th>@lang('global.dentist.patients.fields.name')</th>
                        <th>@lang('global.dentist.patients.fields.rg')</th>
                        <th>@lang('global.dentist.patients.fields.cpf')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                    ...
                    @if (count($items) > 0)
                        @foreach ($items as $item)
                            <tr data-entry-id="{{ $item->id }}">
                                ...
                                <td>{{ $item->cpf }}</td>
                                <td>
                                    <a href="{{ route('dentist.patients.edit',[$item->id]) }}" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
                                    {!! Form::open(array(
