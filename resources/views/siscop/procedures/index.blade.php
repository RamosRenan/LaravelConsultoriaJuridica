...
@section('content_header')
    <h1><i class="fa fa-ambulance"></i> @lang('global.dentist.procedures.title') <small>@lang('global.app_list')</small></h1>
@stop
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-8">
                    <p>
                        <a href="{{ route('dentist.procedures.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                    </p>
                </div>
                <div class="col-md-4">
                    {!! Form::open(['style' => 'display: inline-block;', 'method' => 'GET', 'route' => ['dentist.procedures.index']]) !!}
            ...
            <table class="table table-bordered table-striped dt-select">
                <thead>
                    <tr>
                        ...
                        <th>@lang('global.dentist.procedures.fields.name')</th>
                    ...
                    @if (count($items) > 0)
                        @foreach ($items as $item)
                            <tr data-entry-id="{{ $item->id }}">
                                ...
                                <td>{{ $item->date }}</td>
                                <td>
                                    <a href="{{ route('dentist.procedures.edit',[$item->id]) }}" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
                                    {!! Form::open(array(
