...
@section('content_header')
    <h1><i class="fa fa-stethoscope"></i> @lang('global.dentist.specialties.title') <small>@lang('global.app_edit')</small></h1>
@stop

@section('content')
    {!! Form::model($item, ['method' => 'PUT', 'route' => ['dentist.specialties.update', $item->id]]) !!}
