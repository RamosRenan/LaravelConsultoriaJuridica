...
@section('content')
    <div class="card card-default">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('dentist.dentists.create') }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                </div>
                <div class="col-md-6">
                    <div class="float-sm-right">
                        {{ Form::open(['method' => 'GET', 'route' => ['dentist.dentists.index']]) }}
            ...
            <table class="table table-head-fixed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('dentist.dentists.fields.rg')</th>
                        <th>@lang('dentist.dentists.fields.cpf')</th>
                        <th>@lang('dentist.dentists.fields.name')</th>
                        <th>@lang('dentist.dentists.fields.units')</th>
                        <th>@lang('dentist.dentists.fields.specialty')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                @foreach ($items as $item)
                    <tr data-entry-id="{{ $item->id }}">
                        ...
                        <td class="align-middle text-right">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('dentist.dentists.edit',[$item->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
