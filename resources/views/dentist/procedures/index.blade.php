...
@section('content_header')
    <h1><i class="fa fa-procedures"></i> @lang('dentist.procedures.title') <small>@lang('global.app_list')</small></h1>
@stop
...
<script>
    ...
    var route = '{{ route('dentist.procedures.mass_destroy') }}';
</script>
@stop
...
@section('content')
    <div class="card card-default">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('dentist.procedures.create') }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                </div>
                <div class="col-md-6">
                    <div class="float-sm-right">
                        {{ Form::open(['method' => 'GET', 'route' => ['dentist.procedures.index']]) }}
            ...
            <table class="table table-head-fixed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('dentist.procedures.fields.name')</th>
                        <th>@lang('dentist.procedures.fields.price')</th>
                        <th>@lang('dentist.procedures.fields.date')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-entry-id="{{ $item->id }}">
                        ...
                        <td class="align-middle text-right">
                            {{ Form::open([
                                ...
                                'method' => 'DELETE',
                                'route' => ['dentist.procedures.destroy', $item->id]
                            ]) }}
                            <div class="btn-group">
                                <a href="{{ route('dentist.procedures.edit',[$item->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
