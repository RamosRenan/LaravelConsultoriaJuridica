...
@section('content_header')
    <h1><i class="fa fa-list"></i> @lang('legaladvice.registries.fields.procedures') <small>@lang('global.app_create')</small></h1>
@stop
...
@section('content')
    {!! Form::open(['class' => 'formAjax', 'method' => 'POST', 'route' => ['legaladvice.procedures.store']]) !!}
