    ...
    <div class="col-md-4">
        <div class="info-box bg-green">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><h1>{{ count($items->uptodate) }}</h1></span>
                <div class="progress">
            ...
            @foreach($items->uptodate as $item)
                <tbody>
                    <tr data-entry-id="{{ $item->id }}">
                        ...
                        <td class="text-center">{{ date('d/m/y', strtotime($item->deadline)) }}</td>
                        <td class="text-center"><span class='badge badge-success'>{{ $item->remainingdays }}</span></td>
                        <td class="text-center">{{ $item->files }}</td>
                        <td class="text-center">{{ $item->procedures }}</td>
                        <td class="text-right">
    ...
    <div class="col-md-4">
        <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><h1>{{ count($items->deadline) }}</h1></span>
                <div class="progress">
            ...
            @foreach($items->deadline as $item)
                <tbody>
                    <tr data-entry-id="{{ $item->id }}">
                        <td class="text-center">{{ $item->protocol }}</td>
                        <td class="text-center">{{ date('d/m/y', strtotime($item->deadline)) }}</td>
                        <td class="text-center"><span class='badge badge-warning'>{{ $item->remainingdays }}</span></td>
                        <td class="text-center">{{ $item->files }}</td>
                        <td class="text-center">{{ $item->procedures }}</td>
                        <td class="text-right">
    ...
    <div class="col-md-4">
        <div class="info-box bg-red">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><h1>{{ count($items->late) }}</h1></span>
                <div class="progress">
            ...
            @foreach($items->late as $item)
                <tbody>
                    <tr data-entry-id="{{ $item->id }}">
                        <td class="text-center">{{ $item->protocol }}</td>
                        <td class="text-center">{{ date('d/m/y', strtotime($item->deadline)) }}</td>
                        <td class="text-center"><span class='badge badge-danger'>{{ $item->remainingdays }}</span></td>
                        <td class="text-center">{{ $item->files }}</td>
                        <td class="text-center">{{ $item->procedures }}</td>
                        <td class="text-right">
